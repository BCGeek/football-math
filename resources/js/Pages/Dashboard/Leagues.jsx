...
export default function Leagues(props) {
  ...
  console.log('leagues', props);
    return (
        <AuthenticatedLayout
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Leagues</h2>}
        >
            <Head title="Leagues" />
                          <a className="inline-flex px-5 py-3 text-white
                bg-purple-600 hover:bg-purple-700 focus:bg-purple-700
                rounded-md ml-6 mb-3" onClick={()=>setPage('add')}>Add League</a>
